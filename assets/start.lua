...
LoadEffects("FireWork.xml")
LoadEffects("ChinaBigFlame.xml")
...
function UploadGameIntroNewPlayer()
	UploadResourceGroup("Intro");
	UploadResourceGroup("IntroMenu");
...
GUI:getLayer("Options"):getWidget("SEnvironment"):AcceptMessage(Message("SetPos", tostring(envVolume)))
...
--	UploadResourceGroup("Game")
--	UploadResourceGroup("StageLayer_5")
--	UploadResourceGroup("Clouds")
